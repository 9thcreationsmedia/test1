...
/*
        $("#btn-save").click(function(e){
            ...
            var fname = $("input[name='pfname']").val();
            var lname = $("input[name='plname']").val();
            var phone = $("input[name='pcontact']").val();
            var email = $("input[name='pemail']").val();
            var aadhar = $("input[name='parent_aadhar']").val();
            var pan = $("input[name='parent_pan']").val();
            var relation = $('#prelation').val();
            var qualification = $('#qualification').val();
            var bloodgroup = $('#bloodgroup').val();
            var pcaste = $('#pcaste').val();
            var state = $('#state').val();
            var city = $('#city').val();
            var photo = $("input[name='pphoto']").val();
            var zip = $("input[name='zip']").val();
            var present_add = $("input[name='present_add']").val();
            var perm_add = $("input[name='perm_add']").val();
            var dob = $("input[name='par_dob']").val();
