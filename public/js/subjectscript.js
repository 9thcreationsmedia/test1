    ...
    $(document).on('click','.delete-product',function(){
        ...
        $("#btn-save").click(function(e){
            ...
            $.ajax({
                ...
                url: my_url,
                type:type,
                data: {_token:_token, class_id:class_id, subject_name:subject_name,teacher:teacher,section:section},
                success: function(data) {
                ...
                var product = '<tr id="product' + data[0].id + '"><td>' + data[0].subject_name + '</td><td>' + data[1].class_name + '</td><td>' + data[3].section_name + '</td><td>' + data[2] + '</td>';
