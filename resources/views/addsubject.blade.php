...
<html class="no-js" lang="" ng-app="myApp" ng-cloak>
      ...
      <a href="#"><i class="fa fa-users"></i> <span>Users</span> </a>
         ...
         <li><a href="{{url('addemployee')}}"><i class="fa fa-caret-right"></i> Add Employee</a></li>
           <li><a href="{{url('viewemployee')}}"><i class="fa fa-caret-right"></i>Employee Details</a></li>
             ...
             <ul>
                  <li class="active"><a href="{{url('addsubject')}}"><i class="fa fa-caret-right"></i>Subject Details</a></li>
                  <li><a href="{{url('addchapter')}}"><i class="fa fa-caret-right"></i>Chapter Details</a></li>
 ...
 <button id="btn_add" name="btn_add" class="btn btn-default btn-rounded pull-right"  style="background-color: #2c3e50;color:#fff;">Add New Subject</button>
 <br><br>
    </div>
      <div class="panel-body"> 
        ...
        <thead style="background-color: #2c3e50;color:#fff;">
         ...
         <tbody id="products-list" name="products-list">
           @foreach ($subject as $subjectdata)
            <tr id="product{{$subjectdata->id}}">

              <td>{{$subjectdata->subject_name}}</td>

            @foreach($class as $classname)
             @if($subjectdata->class_id === $classname->id)
             ...
             @if($subjectdata->section_id === $sectionname->id)
             ...
             @endforeach
              ...
              <td>
             <button class="btn btn-xs btn-detail btn-rounded open_modal" value="{{$subjectdata->id}}"  style="background-color:#2c3e50;color:#fff;">Edit</button>&nbsp;&nbsp;&nbsp;
            <button class="btn btn-xs btn-warning btn-rounded btn-delete delete-product" value="{{$subjectdata->id}}">Delete</button>
              </td>
            </tr>
            @endforeach
        </tbody>
  ...
  <div class="alert alert-danger print-error-msg" style="display:none">
        <ul></ul>
            ...
            <form id="frmProducts" name="frmProducts" class="form-horizontal">
                ...
                <div class="form-group">
                 ...
                 <label for="inputDetail" class="col-sm-3 control-label"><span style="color: red">*</span>&nbsp;Subject Name</label>
                    <div class="col-sm-9">
                    <input type="text" class="form-control has-error" id="subject_name" name="subject_name" placeholder="Subject Name" value="" required>
                    </div>
                </div>
            ...
            <button type="button" class="btn btn-primary" id="btn-save" value="add" style="background-color: #2c3e50;color:#fff;">Save Subject</button>
    ...
    <script src="{{asset('js/subjectscript.js')}}"></script>
