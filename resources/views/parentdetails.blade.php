                                        ...
                                        <ul id="navigation">
                                          ...
                                          <!--   <li>
                                            ...
                                            <li class="active open">
                                                ...
                                                <ul>
                                                       <li class="active"><a href="{{url('parentdetails')}}"><i class="fa fa-caret-right"></i>View Parent Details</a></li>
                           ...
                           <!-- tile -->
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>View Parent Details</strong></h1>
                                </div>
                                <!-- /tile header -->
