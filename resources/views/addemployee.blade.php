...
-->
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong style="text-align:center;">Add Employee</strong></h1>
                                    <ul class="controls">
                                        <li class="dropdown">
...
-->
                                    <form name="form" action="employeeaddform" method="post" role="form" id="form" accept-charset="ss.html"  enctype="multipart/form-data">

                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label for="tid"><span style="color: red"></span>&nbsp;ID:</label>
                                                <input type="text" name="id" id="tid" class="form-control" value="" readonly>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="fname"><span style="color: red">*</span>&nbsp;First Name: </label>
                                                <input type="text" name="employee_fname" ng-model="fname" id="fname" class="form-control" pattern="^[a-zA-Z]{2,}$" required>
                                                <div class="ermsg">
                                                <span ng-show="form.fname.$touched && form.fname.$invalid">
                                                    <span style="color: darkorange" ng-show="form.fname.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                    <span style="color: red" ng-show="!form.fname.$error.required && form.fname.$invalid"><i style="color: red" class="fa fa-lg fa-spin fa-exclamation-circle"></i>&nbsp;&nbsp;&nbsp;Enter valid First name</span>
                                                </span></div>
                                            </div>
                                             <div class="form-group col-md-4">
                                                <label for="lname"><span style="color: red">*</span>&nbsp;Last Name: </label>
                                                <input type="text" name="employee_lname" ng-model="lname" id="lname" class="form-control" pattern="^[a-zA-Z]{1,}$" required>
                                                 <div class="ermsg">
                                                <span ng-show="form.lname.$touched && form.lname.$invalid">
                                                    <span style="color: darkorange" ng-show="form.lname.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                    <span style="color: red" ng-show="!form.lname.$error.required && form.lname.$invalid"><i style="color: red" class="fa fa-lg fa-spin fa-exclamation-circle"></i>&nbsp;&nbsp;&nbsp;Enter valid Last name</span>
                                                </span></div>
                             ...
                             <div class="row">
                                 <div class="form-group col-md-4">
                                                ...
                                                <select name="gender" ng-model="gender" id="gender" class="form-control mb-10"                                              required>
                                                 ...
                                                 <div class="ermsg">
                                                <span ng-show="form.gender.$touched && form.gender.$invalid">
                                                    <span style="color: darkorange" ng-show="form.gender.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                </span></div>
                                           ...
                                           <div class="form-group col-md-4">
                                            ...
                                            <div class='input-group' >
                                                <input type='text' class="form-control" name="dob" id="db"  required />
                                             ...
                                             <div class="form-group col-md-4">
                                                ...
                                                <input type="pemail" id="pemail" ng-model="pemail" name="email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"
                                                       ...
                                                       required>
                                                <div class="ermsg">
                                                <span ng-show="form.pemail.$touched && form.pemail.$invalid">
                                                    <span style="color: darkorange" ng-show="form.pemail.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>Required field</span>
                                                    <span style="color: red" ng-show="!form.pemail.$error.required && form.pemail.$invalid"><i style="color: red" class="fa fa-lg fa-spin fa-exclamation-circle"></i>&nbsp;&nbsp;&nbsp;Enter valid Email</span>
                                                </span></div>
                                            </div>
                                            </div>
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                               ...
                                               <div class="ermsg">
                                                <span ng-show="form.phone.$touched && form.phone.$invalid">
                                                    <span style="color: darkorange" ng-show="form.phone.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>Required field</span>
                                                    <span style="color: red" ng-show="!form.phone.$error.required && form.phone.$invalid"><i style="color: red" class="fa fa-lg fa-spin fa-exclamation-circle"></i>&nbsp;&nbsp;&nbsp;Enter valid 10 digit Phone number</span>
                                                </span></div>
                                            </div>
                                             <div class="form-group col-md-4">
                                                <label for="paadharno"><span style="color: red">*</span>&nbsp;Aadhar No: </label>
                                                <input type="text" name="aadhar" ng-model="paadharno" id="paadharno" class="form-control" placeholder="" maxlength="12" pattern="^\d{12}$"
                                                       data-parsley-trigger="change" required>
                                                 <div class="ermsg">
                                                <span ng-show="form.paadharno.$touched && form.paadharno.$invalid">
                                                    <span style="color: darkorange" ng-show="form.paadharno.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>Required field</span>
                                                    <span style="color: red" ng-show="!form.paadharno.$error.required && form.paadharno.$invalid"><i style="color: red" class="fa fa-lg fa-spin fa-exclamation-circle"></i>&nbsp;&nbsp;&nbsp;Enter valid 12 digit Aadhar number</span>
                                                </span></div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="panno">Pan No: </label>
                                                <input type="text" name="pan" ng-model="panno" id="panno" class="form-control" placeholder="" pattern="^[a-zA-Z]{5}[0-9]{4}[a-zA-Z]{1}$" maxlength="10"
                                                       data-parsley-trigger="change">
                                                <div class="ermsg">
                                                <span ng-show="form.panno.$touched && form.panno.$invalid">
                                                    <span style="color: darkorange" ng-show="form.panno.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>Required</span>
                                                    <span style="color: red" ng-show="!form.panno.$error.required && form.panno.$invalid"><i style="color: red" class="fa fa-lg fa-spin fa-exclamation-circle"></i>&nbsp;&nbsp;&nbsp;Enter valid 10 digit Pancard number</span>
                                                </span></div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                             ...
                                             <div class="ermsg">
                                                <span ng-show="form.hobbies.$touched && form.hobbies.$invalid">
                                                    <span style="color: darkorange" ng-show="form.hobbies.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                </span></div>
                                             ...
                                             <div class="ermsg">
                                                <span ng-show="form.religion.$touched && form.religion.$invalid">
                                                    <span style="color: darkorange" ng-show="form.religion.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                </span></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="ermsg">
                                                <span ng-show="form.pcaste.$touched && form.pcaste.$invalid">
                                                    <span style="color: darkorange" ng-show="form.pcaste.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                </span></div>
                                               
                                        </div>
                                            <div class="form-group col-md-4">
                                            <label for="preaddr"><span style="color: red">*</span>&nbsp;Address: </label>
                                            <textarea class="form-control" rows="2" name="present_address" id="preaddr" placeholder="Type your address" ng-model="preaddr" required></textarea>
                                                  <div class="ermsg">
                                                <span ng-show="form.preaddr.$touched && form.preaddr.$invalid">
                                                    <span style="color: darkorange" ng-show="form.preaddr.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                </span></div>
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="ermsg">
                                                <span ng-show="form.city.$touched && form.city.$invalid">
                                                    <span style="color: darkorange" ng-show="form.city.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                </span></div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="ermsg">
                                                <span ng-show="form.state.$touched && form.state.$invalid">
                                                    <span style="color: darkorange" ng-show="form.state.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                </span></div>
                                               
                                        </div>
                                            <div class="form-group col-md-4">
                                            <label for="zipcode"><span style="color: red">*</span>&nbsp;Zip Code: </label>
                                            <input type="text" class="form-control" maxlength="6" pattern="^[0-9]{6}$" name="zip" id="zipcode"  ng-model="zipcode" required>
                                                  <div class="ermsg">
                                                <span ng-show="form.zipcode.$touched && form.zipcode.$invalid">
                                                    <span style="color: darkorange" ng-show="form.zipcode.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                    <span style="color: red" ng-show="!form.zipcode.$error.required && form.zipcode.$invalid"><i style="color: red" class="fa fa-lg fa-spin fa-exclamation-circle"></i>&nbsp;&nbsp;&nbsp;Enter valid 6 digit Zipcode </span>
                                                </span></div>
                                        </div>
                                        <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="ermsg">
                                                <span ng-show="form.qualification.$touched && form.qualification.$invalid">
                                                    <span style="color: darkorange" ng-show="form.qualification.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                </span></div>
                                               
                                        </div>
                                            <div class="form-group col-md-4">
                                                <label for="expy"><span style="color: red">*</span>&nbsp;Experiance in Years:</label>
                                                <input type="text" name="experience_in_years" id="expy" ng-model="expy" class="form-control" required>
                                             <div class="ermsg">
                                                <span ng-show="form.expy.$touched && form.expy.$invalid">
                                                    <span style="color: darkorange" ng-show="form.expy.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                </span></div>
                                            </div>
                                            <div class="form-group col-md-4">
                                               
                                               <label for="certificates">Upload Resume: </label>
                                                 <input class="form-control" type="file" name="upload_resume" >
                                                <!--  {!! Form::file('upload_resume') !!}
                                               --> 
                                            </div>
                                      </div>
                                      <div class="row">
                                          ...
                                          <div class="form-group col-md-4">
                                                 <label for="certificates">Upload Certificates: </label>
                                                   <input class="form-control" type="file" name="upload_certificates" >
                                              <!--    {!! Form::file('upload_certificates') !!} -->
                                        ...
                                        <div class="form-group col-md-4">
                                         ...
                                         <div class="form-group col-md-4">
                                            ...
                                            <div class='input-group'>
                                                <input type='text' class="form-control" name="dol" id="dol" />
                                                <span class="input-group-addon">
                                                    <span class="fa fa-calendar"></span>
                                                </span>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="ermsg">
                                                <span ng-show="form.jtype.$touched && form.jtype.$invalid">
                                                    <span style="color: darkorange" ng-show="form.jtype.$error.required"><i style="color: darkorange" class="fa fa-lg fa-warning"></i>&nbsp;&nbsp;&nbsp;Required field</span>
                                                </span></div>
                                 ...
                                 <div class="tile-footer text-right bg-tr-black lter dvd dvd-top">
                                    <!-- SUBMIT BUTTON -->
                                    <input type="submit" class="btn btn-blue btn-rounded" value="Add" id="">
...
<script>
    ...
    document.querySelector("#zipcode").addEventListener("keyup",function(){
        this.value=this.value.replace(/[^0-9]/g,"");
});
