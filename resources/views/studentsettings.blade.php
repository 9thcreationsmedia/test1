                                           ...
                                           <!--  <li>
                                             ...
                                             <a href="#"><i class="fa fa-user"></i> <span>Student</span> </a>
                                                <ul>
                                                    ...
                                                    <li class="active"><a href="{{url('studentsettings')}}"><i class="fa fa-caret-right"></i>Student Details</a></li>
                                                </ul>
                                            </li>
                                            <li>
                    ...
                    <button class="btn btn-lightred btn-ef btn-ef-4 btn-ef-4c"><i class="fa fa-arrow-left"></i>Update</button>
                        <button class="btn btn-success btn-ef btn-ef-3 btn-ef-3c"  data-dismiss="modal"><i class="fa fa-arrow-right"></i>Cancel</button>
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Student Settings</strong></h1>
                                </div>
                                <!-- /tile header -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-custom" id="editable-usage">
                                            ...
                                            <tr>
                                                ...
                                                <th>TC</th>
                                                <th>Certificate</th>
                                                <th style="width: 160px;" class="no-sort">Action</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                              ...
                                              <td class="actions"><a href="editstudentform/{{$student->id}}">EDIT</a>/<a id="delete" onClick="return confirm('are you sure you want to delete??');" href="{{ URL::to('studentdelete')}}/{{$student->id}}" onclick = "myFunction()">DELETE</a></td>
