                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong style="text-align:center;">Edit Parent</strong></h1>
                                    <ul class="controls">
                                        <li class="dropdown">
...
-->
                                    <form name="form" role="form" id="form" method="post" action="{{action('ParentController@parentupdate')}}" enctype="multipart/form-data">

                                        <div class="row">

                                            <div class="form-group col-md-4">
                                                <label for="fname"><span style="color: red">*</span>&nbsp;First Name: </label>
                                                <input type="text" name="parent_fname" class="form-control" required value="{{$parent->parent_fname}}">
                                                <div class="ermsg">
                                             ...
                                             <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="parent_lname" value="{{$parent->parent_lname}}" id="lname" class="form-control" required>
                                                 <div class="ermsg">
                                             ...
                                             <div class="form-group col-md-4">
                                                ...
                                                <select name="parent_gender" id="gender" class="form-control mb-10"                                              required>
                                           ...
                                           <div class="form-group col-md-4">
                                            <label for="selectclass">Date of Birth</label>
                                            
                                                <input type="text" class="form-control" name="dob" id="sdt" value="<?php echo $parent->dob?>" />
                                          ...
                                          <div class="form-group col-md-4">
                                                ...
                                                <select name="parent_bloodgroup" id="bloodgroup" class="form-control mb-10"
                                                        ...
                                                        >
                                                    <option value="{{$parent->blood_groop}}"> {{$parent->blood_groop}}</option>
                                         ...
                                         <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="parent_aadhar" value="{{$parent->aadhar}}" id="aadharno" class="form-control" placeholder="" maxlength="12" pattern="^\d{12}$"
                                            ...
                                            <div class="form-group col-md-4">
                                            <label for="selectclass">Pan</label>
                                            
                                                <input type="text" class="form-control" name="pan" id="pan" value="<?php echo $parent->pan?>" />
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="selectclass">Caste</label>
                                            
                                                 <select name="caste" id="caste" class="form-control mb-10">
                                                    <option value="{{$parent->caste}}">{{$parent->caste}}</option>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="selectclass">Religion</label>
                                        <select name="religion" id="religion" class="form-control mb-10">
                                                    <option value="{{$parent->religion}}">{{$parent->religion}}</option>
                                         ...
                                         <div class="form-group col-md-4">
                                                <label for="dob"><span style="color: red">*</span>&nbsp;Phone No</label>
                                           
                                                <input type="text" class="form-control" name="phone" id="phone" value="{{$parent->phone}}">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="qualification" id="qualification" value="{{$parent->qualification}}">
                                          ...
                                          <div class="form-group col-md-4">
                                                ...
                                                <input type="file" name="parent_photo" class="form-control" id="stuuploadphoto" value="{{$parent->upload_photo}}" accept="image/jpeg, image/jpg, image/png">
                                   ...
                                   <div style="clear:both;"></div>
                                        ...
                                        <div class="form-group col-md-4">
                                       @if(isset($parent->upload_photo))
                                        
                                           <span style="color:#2980b9">Photo:
                                                  {{$parent->upload_photo}}
                                                </span>
                                        ...
                                        <div style="clear:both;"></div>
                                          ...
                                          <div class="form-group col-md-4">
                                            <label for="selectclass"><span style="color: red">*</span>&nbsp;Relation with Student</label>
                                            
                                                <select name="rws" id="rws" class="form-control mb-10"
                                                        
                                                        required>


                                                      <option value="{{$parent->relation_with_student}}">{{$parent->relation_with_student}}</option>
                                                    @if($parent->relation_with_student=='father')

                                                    <option value="mother">mother</option>
                                                    <option value="guardian">guardian</option>
                                                    @endif

                                                    @if($parent->relation_with_student=='mother')
                                        ...
                                        <div class="form-group col-md-4">
                                                ...
                                                <input type="email" id="email" value="{{$parent->email}}" name="email" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"
                                                       data-parsley-trigger="change"
                                                       >
