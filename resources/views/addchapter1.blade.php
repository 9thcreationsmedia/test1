                           ...
                           <div class="row">
                                 <form name="form" action="chapteraddform" method="post" role="form" id="form">
                                  ...
                                  <div class="row">   
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="ced" class="col-sm-2 control-label">Chapter Start Date</label>
                                            <div class='input-group date col-sm-6' id='datetimepicker1'>
                                                <input type='text' class="form-control" name="chapter_start_date" id="ced" />
                                 ...
                                 <div class="row">
                                        <div class="form-group">
                                            <label for="ced" class="col-sm-2 control-label">Chapter End Date</label>
                                            <div class='input-group date col-sm-6' id='datetimepicker1'>
                                                <input type='text' class="form-control" name="chapter_end_date" id="ced"/>
                                                <span class="input-group-addon">
                                                    <span class="fa fa-calendar"></span>
                                                </span>
                                            </div>
