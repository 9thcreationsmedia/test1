...
<html class="no-js" lang="" ng-app="myApp" ng-cloak>
      ...
      <a href="#"><i class="fa fa-users"></i> <span>Users</span> </a>
         ...
         <li><a href="{{url('addemployee')}}"><i class="fa fa-caret-right"></i> Add Employee</a></li>
           <li><a href="{{url('viewemployee')}}"><i class="fa fa-caret-right"></i>Employee Details</a></li>
             ...
             <ul>
                  <li><a href="{{url('addsubject')}}"><i class="fa fa-caret-right"></i>Subject Details</a></li>
                  <li class="active"><a href="{{url('addchapter')}}"><i class="fa fa-caret-right"></i>Chapter Details</a></li>
 ...
 <button id="btn_add" name="btn_add" class="btn btn-default btn-rounded pull-right"  style="background-color: #2c3e50;color:#fff;">Add New Chapter</button>
 <br><br>
    </div>
      <div class="panel-body"> 
        ...
        <thead style="background-color: #2c3e50;color:#fff;">
         ...
         <tbody id="products-list" name="products-list">
           @foreach ($chapter as $chapterdata)
            <tr id="product{{$chapterdata->id}}">

              <td>{{$chapterdata->chapter_name}}</td>
              <td>{{$chapterdata->chapter_number}}</td>

              @foreach($subject as $subjectname)
             @if($chapterdata->subject_id === $subjectname->id)
             <td>{{$subjectname->subject_name}}</td>
             @endif
             @endforeach

            @foreach($class as $classname)
             @if($chapterdata->class_id === $classname->id)
             ...
             @if($chapterdata->section_id === $sectionname->id)
             <td>{{$sectionname->section_name}}</td>
             @endif
             @endforeach

             <td>{{$chapterdata->chapter_start_date}}</td>
              <td>{{$chapterdata->chapter_end_date}}</td>
             
             <!--  @foreach($subject as $subjectdata)
             @foreach($teacher as $teacherdata)
             @if($subjectdata->teacher_id === $teacherdata->id)
             ...
             @endforeach -->
              ...
              <td>
             <button class="btn btn-xs btn-detail btn-rounded open_modal" value="{{$chapterdata->id}}"  style="background-color:#2c3e50;color:#fff;">Edit</button>&nbsp;&nbsp;&nbsp;
            <button class="btn btn-xs btn-warning btn-rounded btn-delete delete-product" value="{{$chapterdata->id}}">Delete</button>
              </td>
            </tr>
            @endforeach
        </tbody>
  ...
  <div class="alert alert-danger print-error-msg" style="display:none">
        <ul></ul>
            ...
            <form id="frmProducts" name="frmProducts" class="form-horizontal">
                ...
                <div class="form-group">
                 <label for="inputDetail" class="col-sm-3 control-label"><span style="color: red">*</span>&nbsp;Subject Name</label>
                    <div class="col-sm-9">
                    <!-- <input type="text" class="form-control" id="teacher" name="teacher" placeholder="Teacher Name" value=""> -->
                   ...
                   {{ csrf_field() }}
                 <div class="form-group">
                 <label for="inputDetail" class="col-sm-3 control-label"><span style="color: red">*</span>&nbsp;Chapter Name</label>
                    <div class="col-sm-9">
                    <input type="text" class="form-control has-error" id="chapter_name" name="chapter_name" placeholder="Chapter Name" value="" required>
                    </div>
                </div>


                <div class="form-group">
                 <label for="inputDetail" class="col-sm-3 control-label"><span style="color: red">*</span>&nbsp;Chapter Number</label>
                    <div class="col-sm-9">
                    <input type="number" class="form-control has-error" id="chapter_no" name="chapter_no" placeholder="Chapter Number" value="" required>
                    </div>
                </div>


                <div class="form-group">
                 <label for="inputDetail" class="col-sm-3 control-label">Chapter Start Date</label>
                    <div class="col-sm-9">
                    <input type="text" class="form-control has-error" id="chapter_start_date" name="chapter_start_date" placeholder="Chapter Start Date" value="" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                 <label for="inputDetail" class="col-sm-3 control-label">Chapter End Date</label>
                    <div class="col-sm-9">
                    <input type="text" class="form-control has-error" id="chapter_end_date" name="chapter_end_date" placeholder="Chapter End Date" value="" required>
                    </div>
                </div>
            ...
            <button type="button" class="btn btn-primary" id="btn-save" value="add" style="background-color: #2c3e50;color:#fff;">Save Chapter</button>
    ...
    <script src="{{asset('js/chapterscript.js')}}"></script>
